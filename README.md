...
**Версия 1.9.7** - Добавлен якорь для контактов. Ссылка "Контакты" в навигации теперь ведет к подвалу сайта с плавной прокруткой. Сохранено модальное окно контактов для дополнительного доступа.
