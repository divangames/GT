...
### 🌐 Онлайн версия
**Сайт доступен онлайн**: https://divangames.github.io/GT/

### ✨ Последние обновления

📋 **[Полная история обновлений](https://github.com/divangames/GT/blob/main/CHANGELOG.md)** - Детальный журнал всех изменений проекта

**Версия 1.9.8** - Добавлен стильный прелоадер с анимацией логотипа GT7 и стартовым звуком. Прелоадер отображается 15 секунд с плавными анимациями и адаптивным дизайном.

**Версия 1.9.7** - Добавлен якорь для контактов. Ссылка "Контакты" в навигации теперь ведет к подвалу сайта с плавной прокруткой. Сохранено модальное окно контактов для дополнительного доступа. **Проект размещен на GitHub Pages для онлайн-доступа.**
...
### 🌐 Онлайн версия
**Сайт уже доступен онлайн**: https://divangames.github.io/GT/
...
1. **Репозиторий**: https://github.com/divangames/GT
2. **Автоматический деплой**: При каждом `git push` на ветку `main`
3. **GitHub Actions**: Автоматически генерирует данные и обновляет сайт
